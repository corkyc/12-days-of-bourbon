    ...
    if (window.location.pathname.endsWith('all-bottles.html')) {
        ...
        if (guessModal && doors.length > 0) {
            ...
            doors.forEach(door => {
                door.addEventListener('click', function(e) {
                    ...
                    window.requestAnimationFrame(() => {
                        ...
                        // document.body.style.overflowY = 'hidden'; // REMOVED: This line caused the issue.
                    });
                });
            });
            ...
            const closeModalAndRestoreScroll = () => {
                guessModal.style.display = 'none';
                // document.body.style.overflowY = ''; // REMOVED: Since we no longer hide the scrollbar on open, we don't need to restore it.
            };
